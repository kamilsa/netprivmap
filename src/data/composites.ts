...
export const COMPOSITES: Composite[] = [
  ...
  },
  {
    ...
    maturity: 'research',
    atoms: ['A2', 'A4', 'A6'],
    desc: 'A collection of routing and obfuscation techniques designed to support 2-second slot times while maintaining validator anonymity.',
    keyProps: 'Extreme low latency, GPA resistance, volumetric obfuscation.',
    limitations: 'High bandwidth overhead from decoy traffic, complexity of relay management.',
